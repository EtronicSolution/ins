...
include_once './data/ins_list_data.php';
     ...
     <div class="row page-titles">
                ...
                <div class="col-md-7 align-self-center">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Motor List</a></li>
      ...
      <div class="row">
        ...
        <div class="card">
	<div class="card-body">
	   <h4 class="card-title" style="text-transform: uppercase;">Motor List</h4>
            ...
            <div class="table-responsive m-t-40">
             ...
             <tbody>
                ...
                <tr>
                  ...
                  <td><?php echo $row['v_ins_number']; ?></td>
                 
                  <td><?php echo $row['v_ins_member_id']; ?></td>
                  
                  <td><?php echo $row['register_date']; ?></td>
                  
                  <td><?php echo $row['expire_date']; ?></td>
                  
                  <td><?php echo $row['v_ins_agent_id']; ?></td>
                  
                   <td><?php echo $row['v_ins_policy']; ?></td>
