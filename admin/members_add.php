...
if ($error == 1) {
    echo '<script>  swal("User Name already asign", "Please chose different", "warning");</script>';
}
    ...
    ?>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-6 col-md-6 form-group">                  
                                                ...
                                                <input type="<?php if ($row['m_dob'] == '') {
                                                echo "date";
                                            } else {
                                                echo "text";
                                            } ?>" class="form-control date" id="m_dob" placeholder="YYYY-MM-DD" name="m_dob" value="<?php echo $row['m_dob']; ?>" >                            
                                            </div>

                                            <div class="col-lg-6 col-md-6 form-group">                  
                                                <label >Mobile Number :</label>

                                                <input type="tel" class="form-control" id="m_phone" placeholder="Phone" name="m_phone" value="<?php echo $row['m_phone']; ?>"> 						
                                            </div>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-6 col-md-6 form-group">                  
                                                <label>Nic :</label>
                                                <input type="text" id="m_lineid" autocomplete="off" name="m_nic" class="form-control" placeholder="NIC"  value="<?php echo $row['m_nic']; ?>" >                            
                                            </div>
                                            <div class="col-lg-6 col-md-6 form-group">
                                                <label>Passport :</label>
                                                <input type="text" id="m_passport" name="m_passport"  class="form-control" placeholder="PASSPORT" value="<?php echo $row['m_passport'] ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-6 col-md-6 form-group">                  
                                                <label>BRID :</label>
                                                <input type="text" id="m_brid" autocomplete="off" name="m_brid" class="form-control" placeholder="BRID"  value="<?php echo $row['m_brid']; ?>" >                            
                                            </div>
                                            <div class="col-lg-6 col-md-6 form-group">
                                                <label>Army/ Police :</label>
                                                <input type="text" id="m_mil_id" name="m_mil_id"  class="form-control" placeholder="Army/ Police" value="<?php echo $row['m_mil_id'] ?>">
                                            </div>
                                        </div>
...
?>
                                            ...
                                            <div class="col-lg-6 col-md-6 form-group">
                                                ...
                                                <input type="text"  id="m_address" name="m_address" class="form-control " placeholder="Your Postcode" value="<?php echo $row['m_address'] ?>">
                                            </div><!-- End .input-group -->
                                        </div>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-lg-6 col-md-6 form-group">                  
                                                ...
                                                <select class="form-control" name="m_marriage_status" id="m_marriage_status" >
