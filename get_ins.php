        ...
        <form action="data/policy_data.php" class="templatemo-login-form" method="post" enctype="multipart/form-data" name="update_members">
            ...
            <div class="pb-2 form-group">
                ...
                <div class="col-lg-12 col-md-12">
                    <input name="v_number" placeholder="WC1111R" maxlength="10" type="text" class="form-control" required>
                ...
                <div class="col-lg-12 col-md-12">
                    <input name="postcode" placeholder="52100" maxlength="6" type="text" class="form-control" value="" required>
                    <div class="invalid-feedback"></div>
                </div>
                <label class="pl-3 form-label" lg="2">IC Number Type 
                    <span class="compulsory-color">*</span>
                </label>
                <div class="col-lg-12 col-md-12">
                   
                     <select  name="ic_type"  class="form-control" required>
                ...
                <div class="col-lg-12 col-md-12">
                    ...
                    <input name="m_nic" placeholder="900511071234" maxlength="12" type="text" class="form-control" value="">
                    <div class="invalid-feedback"></div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-lg-12 col-md-12">
                        <input name="m_phone" placeholder="0141231231" maxlength="20" type="text" class="form-control" value="">
                ...
                <div class="pl-3">
                    ...
                    <div class="form-check form-check-inline">
                        ...
                        <input name="m_marriage_status" type="radio" class="form-check-input" value="2"><label title="" type="checkbox" class="form-check-label">Single</label></div><div class="form-check form-check-inline"><input name="m_marriage_status" type="radio" class="form-check-input" value="1"><label title="" type="checkbox" class="form-check-label">Married</label></div><div class="invalid-feedback">
                    </div>
                    <div class="invalid-feedback"></div>
                </div>
            </div>
